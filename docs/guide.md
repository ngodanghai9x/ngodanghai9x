...
- [Tự host GitLab Runner](https://github.com/ngodanghai9x/learn-os-deployments/blob/main/.github/author-profile/gitlab-runner-guide.md) — bypass lỗi pipeline fail do account chưa verify identity, dùng runner riêng qua Docker Compose thay vì shared runner.
